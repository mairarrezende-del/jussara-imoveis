  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <link rel="icon" href="https://idyezzltmfyxlpljcetk.supabase.co/storage/v1/object/public/fotos/logo-jussara.png" type="image/png" />
        <link rel="apple-touch-icon" href="https://idyezzltmfyxlpljcetk.supabase.co/storage/v1/object/public/fotos/logo-jussara.png" />
